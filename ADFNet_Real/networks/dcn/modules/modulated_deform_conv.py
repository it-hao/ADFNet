...
class ModulatedDeformConvPack(ModulatedDeformConv):
    ...
    def __init__(self, in_channels, out_channels,
                 kernel_size, stride, padding,
                 dilation=1, groups=1, deformable_groups=1, im2col_step=64, bias=True, lr_mult=0.1, extra_offset_mask=False, offset_in_channel=32):
        super(ModulatedDeformConvPack, self).__init__(in_channels, out_channels,
                                  kernel_size, stride, padding, dilation, groups, deformable_groups, im2col_step, bias)
    ...
    def forward(self, x):
        ...
        return ModulatedDeformConvFunction.apply(x, offset, mask,
                                                self.weight,
                                                self.bias,
                                                self.stride,
                                                self.padding,
