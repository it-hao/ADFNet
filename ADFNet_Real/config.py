...
class Config(object):
    ...
    def __init__(self, config_yaml: str, config_override: List[Any] = []):
        ...
        self._C.OPTIM.NUM_EPOCHS = 60
        self._C.OPTIM.NEPOCH_DECAY = [100]
        self._C.OPTIM.LR_INITIAL = 0.0001
        ...
        self._C.TRAINING.TRAIN_DIR = '/media/zqzhao/Win101/data_noise/SIDD/train_v2'
        self._C.TRAINING.VAL_DIR = '../../../data_noise/SIDD/val'
