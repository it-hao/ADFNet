...
parser.add_argument('--weights', type=str, default='./checkpoints/adfnet_n50.pt', help="Path to pretrained model") 
parser.add_argument("--input_dir", type=str, default='./testsets/BSD68', help='test on Kodak24, BSD68, Urban100 and McMaster')
...
def main():
    ...
    files_source = glob.glob(os.path.join(opt.input_dir, '*'))
    files_source.sort()
