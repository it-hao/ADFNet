...
class Data:
    def __init__(self, args):
        ...
        if args.data_val in ['Set12', 'Kodak24', 'BSD68', 'Urban100']: # 噪声数据集
            ...
            module_test = import_module('data.' +  args.data_val.lower())
            testset = getattr(module_test, args.data_val)(args, train=False)
